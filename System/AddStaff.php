                ...
                <div class="col-lg-12">
					...
					<div class="panel-body">
						...
						<?php
							...
							{
							echo'<li ><a href="ViewAllStaff.php?q='.$user.'">View All Staff</a></li>';
							echo'<li class="active"><a>Add Staff</a></li>';
							echo '<li>
						...
						<form id="upload" action="ViewAllStaff.php<?php echo '?q='.$user;?>" method="POST">
							...
							<th><input name="Name" class="form-control"><br></th></tr>
							<tr><th><Label>Surname: &nbsp;</Label></th>
							<th><input name="Surname" class="form-control"><br></th></tr>
							</table>
							<br>
