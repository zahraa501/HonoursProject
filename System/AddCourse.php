                ...
                <div class="col-lg-12">
					...
					<div class="panel-body">
						<ul class="nav nav-pills">
							...
							<li class="active"><a href="#">Add a Course</a>
							</li>
						...
						<form id="upload" action="ViewFiles.php" method="POST">
							<table>
							<tr><th><Label>Course Name: &nbsp;</Label></th>
							<th><input name="Course" class="form-control"><br></th></tr>
							<tr><th><Label>Course Convenor: &nbsp;</Label></th>
							<th><input name="Convenor" class="form-control"><br></th></tr>
							<tr><th><Label>Teaching Assistant: &nbsp;</Label></th>
							<th><input name="TA" class="form-control"><br></th></tr>
