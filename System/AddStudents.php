                ...
                <div class="col-lg-12">
					...
					<div class="panel-body">
						...
						<br>
							...
							?>
							<tr><td><Label>List of Students: &nbsp;</Label></td><td><input type="file" name="file" id="file" class="btn btn-default"/></td></tr>
							</table>
								
							<br>
							<input type="submit" name="SubmitStudents" value="Add" class="btn btn-default">
						</form>	
					</div>
